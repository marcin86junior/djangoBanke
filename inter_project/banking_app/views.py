...
from .serializers import AccountSerializer, TransactionSerializer, UserSerializer, MyAccountSerializer
import decimal


def homepage(request):
    return render(request, 'banking_app/index.html', )
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def create_deposit(self, request):
        amount = request.data.get('amount')
        serializer = self.get_serializer(data={'amount': amount, 'transaction_type': 'DEPOSIT'})
    ...
    def create_withdrawal(self, request):
        ...
        if account.balance >= amount:
            serializer = self.get_serializer(data={'amount': amount, 'transaction_type': 'WITHDRAW'})
            serializer.is_valid(raise_exception=True)
            serializer.save()
...
class TransactionListViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return render(request, 'banking_app/transaction_list.html', {'transactions': transactions})
...
class TransferView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            from_account = Account.objects.get(account_no=from_account_id, user=request.user)
